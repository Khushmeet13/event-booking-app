            ...
            <div className="relative h-28 bg-gradient-to-br from-[#1a1608] to-[#0f0f17] overflow-hidden">
              ...
              <div className="absolute inset-0 flex items-center px-6">
                ...
                <div className="ml-auto">
                  <span
                    className={`text-xs tracking-widest uppercase px-3 py-1 rounded-full font-bold ${ticket.type === "VIP"
...
// ---------- Main ----------
export default function TicketConfirmation({ tickets, whatsappUrl, onHome }) {
      ...
      <div className="flex flex-col sm:flex-row gap-3 justify-center">
        ...
        {whatsappUrl && (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="px-8 py-3.5 border border-[#25D366]/30 text-[#25D366] text-xs tracking-[0.2em] uppercase rounded-xl hover:bg-[#25D366]/10 transition-all flex items-center justify-center gap-2"
          >
            <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current">
